...
public class AcademicPlan implements Cloneable {
    ...
    */
    ...
    @Override
    public AcademicPlan clone() throws CloneNotSupportedException {
        AcademicPlan ap = (AcademicPlan) super.clone();
        ap.subjects = (HashMap<String, Subject>) ap.subjects.clone();
        return ap;
    }
    ...
    */
    ...
    public ArrayList<String> getSubjectNames(){
        ...
        for(String e : subjects.keySet()) s.add(e);
        return s;
    }
    ...
    */
    ...
    public Vector<String> getNameSubjects(){
        Vector<String> aux = new Vector<>();
        for(String e : subjects.keySet()) aux.add(e);
        return aux;
    }
