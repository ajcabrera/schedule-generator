...
public class Group implements Cloneable {
    ...
    */
    ...
    public void printTypes() {
        for (String s : subgroups.keySet()) {
            ...
            System.out.println("type groupSubject: " + aux.getSessionType());
            System.out.println("length groupSubject: " + aux.getSessionLength());
            System.out.println("week groupSubject: " + aux.getSessionsWeek());
        }
    }
    ...
    */
    public Vector<schedule.domain.GroupSubject> getSubgroups(String type) {
